...
silent only
cd /cygdrive/d/GIT_Local_Repository/budget.JS
...
setlocal tabstop=8
setlocal tags=/cygdrive/d/GIT_Local_Repository/budget.JS/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
...
setlocal tabstop=8
setlocal tags=/cygdrive/d/GIT_Local_Repository/budget.JS/.git/javascript.tags,/cygdrive/d/GIT_Local_Repository/budget.JS/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 12 - ((1 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
