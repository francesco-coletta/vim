...
silent only
cd /cygdrive/c/GIT_Local_Repository/elasticsearch/kibana
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +38 Gruntfile.js
badd +36 ./package.json
badd +1 src/app/app.js
badd +46 src/config.js
badd +0 src/app/panels/histogram/module.js
badd +0 src/app/services/querySrv.js
badd +1 src/app/
args Gruntfile.js
edit src/app/services/querySrv.js
...
setlocal tabstop=8
setlocal tags=/cygdrive/c/GIT_Local_Repository/elasticsearch/kibana/.git/javascript.tags,/cygdrive/c/GIT_Local_Repository/elasticsearch/kibana/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
