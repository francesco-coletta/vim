...
set nrformats=hex
set ruler
set runtimepath=~/.vim,~/.vim/plugged/seoul256.vim/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/ultisnips/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/vim-github-dashboard/,~/.vim/plugged/gocode/vim/,~/.fzf/,~/my-prototype-plugin/,~/.vim/bundle/ack,~/.vim/bundle/command-t,~/.vim/bundle/fugitive,~/.vim/bundle/git,~/.vim/bundle/gundo,~/.vim/bundle/makegreen,~/.vim/bundle/minibufexpl,~/.vim/bundle/nerdtree,~/.vim/bundle/pep8,~/.vim/bundle/py.test,~/.vim/bundle/pydoc,~/.vim/bundle/ropevim,~/.vim/bundle/snipmate,~/.vim/bundle/supertab,~/.vim/bundle/surround,~/.vim/bundle/syntastic,~/.vim/bundle/tasklist,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-sensible,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/bundle/snipmate/after,~/.vim/plugged/ultisnips/after,~/.vim/after
set scrolloff=1
set shiftround
set showcmd
set sidescrolloff=5
...
let s:l = 146 - ((47 * winheight(0) + 24) / 49)
