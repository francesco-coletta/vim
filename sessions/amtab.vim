...
silent only
cd /cygdrive/c/GIT_Local_Repository/amtabEs/kibana
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 src/app/app.js
badd +44 src/app/services/querySrv.js
badd +1 src/app/panels/histogram/module.js
badd +1 src/app/panels/histogram/interval.js
badd +68 src/app/panels/histogram/timeSeries.js
silent! argdel *
edit src/app/panels/histogram/module.js
...
setlocal tabstop=8
setlocal tags=/cygdrive/c/GIT_Local_Repository/amtabEs/.git/javascript.tags,/cygdrive/c/GIT_Local_Repository/amtabEs/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
...
559
normal! zo
let s:l = 58 - ((57 * winheight(0) + 37) / 74)
...
wincmd w
argglobal
edit src/app/panels/histogram/timeSeries.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
224
normal! zo
let s:l = 68 - ((67 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
